    ...
    public class GridLocalizer_zhchs : GridLocalizer
    {
        ...
        public override string GetLocalizedString(GridStringId id)
        {
            switch (id)
            {
                ...
                case GridStringId.MenuColumnFindFilterShow: return "显示查找面板";
                case GridStringId.MenuColumnFindFilterHide: return "隐藏查找面板";
                case GridStringId.MenuColumnAutoFilterRowShow: return "显示过滤行";
                case GridStringId.MenuColumnAutoFilterRowHide: return "隐藏过滤行";
                case GridStringId.FindControlFindButton: return "查找";
                case GridStringId.FindControlClearButton: return "清空";
